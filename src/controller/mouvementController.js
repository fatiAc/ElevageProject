...
router.post('/createMouvmntMesure', function (req, res) {
    if (req.body.poids != null) {
        mesureSrv.create(req.body.poids, req.body.date, req.body.user_login, req.body.animal_ID)
            .then(mesureData => {
                if (mesureData != null) {
                    mouvementSrv.create(req.body.date, req.body.paddock_src, req.body.paddock_dest, req.body.animal_ID, req.body.user_login, mesureData.id)
                        .then(mouvementData => {
        ...
        mouvementSrv.create(req.body.date, req.body.paddock_src, req.body.paddock_dest, req.body.animal_ID, req.body.user_login, null)
            .then(mouvementData => {
                res.status(200).send(mouvementData);
            })
    }
    ...
    animalSrv.findAllByPaddock(req.body.paddock_src)
        .then(animalsData => {
            ...
            for (let animal of animalsData) {
                mouvementSrv.create(req.body.date, req.body.paddock_src, req.body.paddock_dest, animal.snit, req.body.user_login, null)
                    .then(mouvementData => {
                        i++;
