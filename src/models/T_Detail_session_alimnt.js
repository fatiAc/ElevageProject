...
Detail_session_alimnt.hasMany(Periode_ration, {as : 'T_Periode_Ration', foreignKey: 'detailAlimentation_ID', sourceKey: 'id'});
Periode_ration.belongsTo(Detail_session_alimnt, {as : 'T_Detail_session_alimnt', foreignKey: 'detailAlimentation_ID', targetKey: 'id'});
