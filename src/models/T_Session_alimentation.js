...
Session_alimentation.hasMany(Detail_alimentation, {as : 'T_Detail_session_alimnt', foreignKey: 'session_alimentation_ID', sourceKey: 'id'});
Detail_alimentation.belongsTo(Session_alimentation, {as : 'T_Session_alimentation', foreignKey: 'session_alimentation_ID', targetKey: 'id'});


Session_alimentation.hasMany(Recup_session_alimentation, {as : 'T_Recup_sessionAlimnt', foreignKey: 'sessionAlimnt_ID', sourceKey: 'id'});
