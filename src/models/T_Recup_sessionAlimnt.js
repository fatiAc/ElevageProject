...
Recup_sessionAlimnt.hasMany(Ingredient_param, {as : 'T_Ingredient_param', foreignKey: 'recupSession_ID', sourceKey: 'id'});
Ingredient_param.belongsTo(Recup_sessionAlimnt, {as : 'T_Recup_sessionAlimnt', foreignKey: 'recupSession_ID', sourceKey: 'id'});
